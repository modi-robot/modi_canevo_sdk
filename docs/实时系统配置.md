...
![image-20260330150141129](pics/05_image.png)
注册名*：Windy Toffee
...
GRUB_CMDLINE_LINUX_DEFAULT="quiet splash isolcpus=2 nohz_full=2 rcu_nocbs=2 rcu_nocb_poll nosmt irqaffinity=0,1,3 rcupdate.rcu_expedited=1 kernel.nmi_watchdog=0 audit=0 mce=off idle=poll nosoftlockup page_alloc.shuffle=0 intel_idle.max_cstate=0 processor.max_cstate=0 usbcore.autosuspend=-1 pcie_aspm=off"
...
![6d13dbae5bd586632a9fde18e4e12ce3](pics/30_image.jpg)

改成

![26b613b653d39fb17c425637c7b95d0e](pics/31_image.jpg)
ctrl+x保存，输入y确认
...
![23a064411d7bbfe6f7f8ae73917e4210](pics/33_image.jpg)
...
![image-20260403161931190](pics/34_image.png)
看到kcan就成功了
